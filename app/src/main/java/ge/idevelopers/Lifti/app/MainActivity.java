...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        SlideButton slide = (SlideButton) findViewById(R.id.sliderBtn);
//start
        ...
        checkSettings();
       /* SlideButton slide = new SlideButton(getApplicationContext());
        slide.setThumb(ContextCompat.getDrawable(getApplicationContext(),R.drawable.thumb_def));
        slide.setBackgroundResource(R.drawable.back_slide_button);*/
      ...
      /*  radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                if (btnBroken.isChecked()) {
                  // btnBroken.setBackgroundResource(R.drawable.selectedbroken);
                    //btnStuck.setBackgroundResource(R.drawable.unselectedstuck);
                } else {
                 //   btnStuck.setBackgroundResource(R.drawable.selectedstuck);
                   // btnBroken.setBackgroundResource(R.drawable.unselectedbroken);
                }
            }
        });*/
        //   checkSettings();
        //list start
        String[] menu_Item = {"მთავარი", "ჩვენ შესახებ", "პარტნიორები", "დახურვა"};
        ListAdapter ladonew = new CustomAdapter(this, menu_Item, imgid);
        ListView menu = (ListView) findViewById(R.id.lvMenuList);
        menu.setAdapter(ladonew);
        menu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String menu_item = String.valueOf(adapterView.getItemAtPosition(i));

...
public class SlideButton extends FrameLayout {
    ...
    public void init(@Nullable AttributeSet set){
        ...
        if(set != null){
            ...
            if(a.hasValue(R.styleable.slider_button_thumb)){
                ...
                slideBar.setThumb(ContextCompat.getDrawable(getContext(),R.drawable.stuck));

            }

            if(a.hasValue(R.styleable.slider_button_thumbOffset)){
                int offset = a.getDimensionPixelSize(R.styleable.slider_button_thumbOffset,dpToPixels(16));
                offsetThumb += offset;
            }
    ...
    public void setThumb(Drawable drawable){
        ...
        slideBar.offsetLeftAndRight(dpToPixels(0));
    }
        ...
        public boolean onTouchEvent(MotionEvent event) {
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                if (getProgress() > 50){
                    ...
                    onSlide();
                setProgress(100);
                    slideBar.setThumb(ContextCompat.getDrawable(getContext(),R.drawable.broken));
                }
